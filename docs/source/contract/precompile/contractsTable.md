...
| 22 |              | DataContract                 | 数据交易合约       | 有       | zltc_QN1uHLYQoHj2xAy9iKM5WpFJxXChfUbBB | 0x0044617461436f6e747261637441646472657373 |                                         
		...
		"outputs": [
			{
				...
				"internalType": "struct ContractManager.ContractInfo[]",
				"name": "",
				"type": "tuple[]"
			}
		],
