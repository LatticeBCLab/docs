...
![合约管理+合约生命周期+配置更改接口说明文档](E:\0BBBBB\中科晶格\doc\产品\合约管理+合约生命周期+配置更改接口说明文档.assets\合约管理+合约生命周期+配置更改接口说明文档.jpg)
...
>[OperationCommandString](../合约内部管理操作指令/合约内部管理操作指令说明.md) string         `json:"operationCommandString"` //操作命令字符串 [C/R/U/D][W/B/M]AccountAddress
